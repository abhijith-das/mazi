...
Future<void> submit() async {
  ...
  CollectionReference _todo =
      FirebaseFirestore.instance.collection(addr);
...
void cancel(){
      ...
      child: Container(
        ...
        child: Row(
          ...
          children:<Widget>[
            ...
            SizedBox(width: 20,),
            Text(tasks[index],style: TextStyle(fontSize: 20,color: Colors.white),),
            
            Container(
              alignment: Alignment.centerLeft,
              child: Align(
                alignment: Alignment.topRight,
                child: IconButton(onPressed: deletetask, icon: Icon(Icons.delete,color: Colors.white)),
              ) 
  ...
  getgrpofuser() async {
   ...
   String gid= " ";
   final list= await FirebaseFirestore.instance.collection('Users').where('uid', isEqualTo: id).get();
